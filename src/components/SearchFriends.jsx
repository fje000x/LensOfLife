...
const SearchFriends = () => {
  ...
  const handleAddFriend = async (friendUid, friendUsername,profilePicture) => {
    if (!currentUser) {
      ...
      <ul className={styles.userList}>
        ...
        {searchResults.map((user) => (
          <li key={user.uid} className={styles.userItem}>
            ...
            {!user.isAdded ? (
              <button onClick={() => handleAddFriend(user.uid, user.username,user.profilePicture)} className={styles.addFriendButton}>
